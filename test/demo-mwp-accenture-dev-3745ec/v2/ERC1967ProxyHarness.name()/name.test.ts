...
describe("ERC1967ProxyHarness::name()", async () => {
  let acct0xf39f,
  ...
  it("0x3cb260", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b5e27

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.name()).to.equal("MakeWorldPeace");
