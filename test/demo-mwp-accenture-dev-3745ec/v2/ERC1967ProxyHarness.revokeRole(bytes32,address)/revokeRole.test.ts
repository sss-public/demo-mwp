...
describe("ERC1967ProxyHarness::revokeRole(bytes32,address)", async () => {
  ...
  it("0x3cb377", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3bd805
  ...
  it("0x3cafd9", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3af701
  ...
  it("0x3caf85", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b6769
  ...
  it("0x3caf81", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3bd026
