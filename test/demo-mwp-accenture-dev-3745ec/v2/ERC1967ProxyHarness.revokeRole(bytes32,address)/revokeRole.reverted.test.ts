...
describe("ERC1967ProxyHarness::revokeRole(bytes32,address) - reverted", async () => {
  ...
  it("0x3cb09b", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b7727
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `revokeRole(bytes32,address)` */);
  });
