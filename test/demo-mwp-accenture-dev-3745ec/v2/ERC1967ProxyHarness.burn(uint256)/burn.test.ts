...
describe("ERC1967ProxyHarness::burn(uint256)", async () => {
  ...
  it("0x3cb35a", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b0c43

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burn(0x10b9d141774cdc3ffc0000n);
  ...
  it("0x3cb285", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b1ae4

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burn(0xfffffffffffffffffffffn);
  ...
  it("0x3caebc", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a75e7

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burn(0);
