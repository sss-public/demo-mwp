...
describe("ERC1967ProxyHarness::burn(uint256) - reverted", async () => {
  ...
  it("0x3caf56", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b8122
  ...
  it("0x3cae8f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b8e1c

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burn(0x90b9d141774cdc3ffd0000n)).to.be.revertedWith(
