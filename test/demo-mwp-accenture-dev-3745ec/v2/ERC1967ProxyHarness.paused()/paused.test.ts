...
describe("ERC1967ProxyHarness::paused()", async () => {
  ...
  it("0x3cb1fb", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39897c

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.paused()).to.equal(false);
