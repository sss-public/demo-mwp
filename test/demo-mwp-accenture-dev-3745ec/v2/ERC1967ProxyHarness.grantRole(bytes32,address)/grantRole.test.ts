...
describe("ERC1967ProxyHarness::grantRole(bytes32,address)", async () => {
  ...
  it("0x3cb281", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a3f06
  ...
  it("0x3cb062", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x398a18
  ...
  it("0x3caf16", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a51e5
  ...
  it("0x3cadd7", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b5887
