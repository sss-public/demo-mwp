...
describe("ERC1967ProxyHarness::approve(address,uint256) - reverted", async () => {
  ...
  it("0x3cb09a", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3aef31
  ...
  it("0x3caeea", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a7179

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(erc1967proxyHarness0x9fe4MakeWorldPeaceV2.approve(ethers.constants.AddressZero, 0)).to.be.revertedWith(
