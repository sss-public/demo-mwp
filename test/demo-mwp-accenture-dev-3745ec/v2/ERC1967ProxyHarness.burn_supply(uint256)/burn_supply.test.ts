...
describe("ERC1967ProxyHarness::burn_supply(uint256)", async () => {
  ...
  it("0x3cb143", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39dc84

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burn_supply(0x10b9d141774cdc3ffc0000n);
  ...
  it("0x3cb0a0", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b18fa

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burn_supply(0xfffffffffffffffffffffn);
