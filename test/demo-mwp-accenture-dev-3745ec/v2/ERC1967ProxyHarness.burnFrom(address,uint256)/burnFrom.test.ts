...
describe("ERC1967ProxyHarness::burnFrom(address,uint256)", async () => {
  let acct0xf39f,
  ...
  it("0x3cb1bf", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3989ed

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burnFrom("0x0100000000000000000000000000000000000000", 0);
  ...
  it("0x3cb1a1", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a8e11

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.burnFrom(acct0xf39f.address, 0);
