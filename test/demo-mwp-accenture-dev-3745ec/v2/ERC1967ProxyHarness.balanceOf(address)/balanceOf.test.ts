...
describe("ERC1967ProxyHarness::balanceOf(address)", async () => {
  ...
  it("0x3cb1c2", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a7ec6

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.balanceOf(ethers.constants.AddressZero)).to.equal(0);
  ...
  it("0x3cafb8", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b9150

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.balanceOf(acct0xf39f.address)).to.equal(0x10b9d141774cdc3ffc0000n);
