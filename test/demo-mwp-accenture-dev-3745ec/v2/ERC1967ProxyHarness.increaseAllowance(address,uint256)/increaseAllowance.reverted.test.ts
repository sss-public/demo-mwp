...
describe("ERC1967ProxyHarness::increaseAllowance(address,uint256) - reverted", async () => {
  ...
  it("0x3cb15e", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3bd190

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(erc1967proxyHarness0x9fe4MakeWorldPeaceV2.increaseAllowance(ethers.constants.AddressZero, 0)).to.be.revertedWith(
      "ERC20: approve to the zero address"
    );
  });

  it("0x3cae06", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3ac994
