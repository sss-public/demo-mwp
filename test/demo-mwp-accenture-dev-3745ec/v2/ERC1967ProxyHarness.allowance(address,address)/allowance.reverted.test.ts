...
describe("ERC1967ProxyHarness::allowance(address,address) - reverted", async () => {
  ...
  it("0x3cae34", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a4cac
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
