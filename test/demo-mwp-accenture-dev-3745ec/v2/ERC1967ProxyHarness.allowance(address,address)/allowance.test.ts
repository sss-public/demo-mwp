...
describe("ERC1967ProxyHarness::allowance(address,address)", async () => {
  ...
  it("0x3caf5f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3af37b

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.allowance(ethers.constants.AddressZero, ethers.constants.AddressZero)).to.equal(
      0
    );
