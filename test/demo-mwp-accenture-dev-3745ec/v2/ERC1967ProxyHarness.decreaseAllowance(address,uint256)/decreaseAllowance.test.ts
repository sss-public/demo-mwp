...
describe("ERC1967ProxyHarness::decreaseAllowance(address,uint256)", async () => {
  ...
  it("0x3cb34e", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a9682

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.decreaseAllowance("0x0100000000000000000000000000000000000000", 0);
