...
describe("ERC1967ProxyHarness::totalSupply() - reverted", async () => {
  let acct0xf39f,
  ...
  it("0x3cb0b2", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3c0f3b
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
