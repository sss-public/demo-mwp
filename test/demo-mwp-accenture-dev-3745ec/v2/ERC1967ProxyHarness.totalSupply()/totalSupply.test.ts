...
describe("ERC1967ProxyHarness::totalSupply()", async () => {
  ...
  it("0x3cb15b", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3acb3a

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.totalSupply()).to.equal(0x10b9d141774cdc3ffc0000n);
