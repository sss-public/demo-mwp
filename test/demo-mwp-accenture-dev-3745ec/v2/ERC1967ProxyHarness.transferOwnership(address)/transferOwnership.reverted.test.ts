...
describe("ERC1967ProxyHarness::transferOwnership(address) - reverted", async () => {
  ...
  it("0x3cafba", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x399439

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(erc1967proxyHarness0x9fe4MakeWorldPeaceV2.transferOwnership(ethers.constants.AddressZero)).to.be.revertedWith(
      "Ownable: new owner is the zero address"
    );
  });

  it("0x3cade2", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39e8fd
