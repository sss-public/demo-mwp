...
describe("ERC1967ProxyHarness::transferOwnership(address)", async () => {
  ...
  it("0x3cb1ca", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a1fe0

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.transferOwnership("0x0100000000000000000000000000000000000000");
  ...
  it("0x3caf0f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3aa117

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.transferOwnership(acct0xf39f.address);
