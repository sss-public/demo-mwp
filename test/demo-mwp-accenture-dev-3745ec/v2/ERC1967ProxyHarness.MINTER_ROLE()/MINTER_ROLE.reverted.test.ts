...
describe("ERC1967ProxyHarness::MINTER_ROLE() - reverted", async () => {
  ...
  it("0x3cae26", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b559c
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `MINTER_ROLE()` */);
  });
