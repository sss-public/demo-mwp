...
describe("ERC1967ProxyHarness::renounceRole(bytes32,address)", async () => {
  let acct0xf39f,
  ...
  it("0x3cb0c3", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39ba0c
  ...
  it("0x3cb027", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39eb44
  ...
  it("0x3caf0d", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a9210
  ...
  it("0x3cae79", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b1bcf
