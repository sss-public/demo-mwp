...
describe("ERC1967ProxyHarness::proxiableUUID() - reverted", async () => {
  ...
  it("0x3cb10d", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3c264e
  ...
  it("0x3cafa4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3abe03

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(erc1967proxyHarness0x9fe4MakeWorldPeaceV2.proxiableUUID()).to.be.revertedWith(
