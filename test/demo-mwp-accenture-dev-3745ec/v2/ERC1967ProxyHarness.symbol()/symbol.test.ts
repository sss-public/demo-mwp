...
describe("ERC1967ProxyHarness::symbol()", async () => {
  let acct0xf39f,
  ...
  it("0x3caeae", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b19d4

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.symbol()).to.equal("MWP");
