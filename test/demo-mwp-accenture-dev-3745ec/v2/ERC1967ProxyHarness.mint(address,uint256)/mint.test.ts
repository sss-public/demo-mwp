...
describe("ERC1967ProxyHarness::mint(address,uint256)", async () => {
  let acct0xf39f,
  ...
  it("0x3cb375", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b481a

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.mint(acct0xf39f.address, 0x3e19e0c9bab2400101n);
  ...
  it("0x3cb2c5", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3ae2a9

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.mint("0x0100000000000000000000000000000000000000", 0x3e19e0c9bab2400101n);
  ...
  it("0x3cb2a9", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3c0f97

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.mint("0x0100000000000000000000000000000000000000", 0);
  ...
  it("0x3cb0a3", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39bce4

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.mint(acct0xf39f.address, 0);
