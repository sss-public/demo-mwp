...
describe("ERC1967ProxyHarness::hasRole(bytes32,address) - reverted", async () => {
  let acct0xf39f,
  ...
  it("0x3cb370", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39b37e
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `hasRole(bytes32,address)` */);
  });
