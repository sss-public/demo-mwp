...
describe("ERC1967ProxyHarness::hasRole(bytes32,address)", async () => {
  let acct0xf39f,
  ...
  it("0x3cb17f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3ae308
  ...
  it("0x3cb105", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39bdaa
  ...
  it("0x3cb0b7", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a4bd1
  ...
  it("0x3caebb", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a6700
