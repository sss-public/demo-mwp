...
describe("ERC1967ProxyHarness::transfer(address,uint256) - reverted", async () => {
  ...
  it("0x3cb0ed", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a90ae

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(
      erc1967proxyHarness0x9fe4MakeWorldPeaceV2.transfer("0x0100000000000000000000000000000000000000", 0x30b9d141774cdc3ffd0000n)
    ).to.be.revertedWith("ERC20: transfer amount exceeds balance");
  });

  it("0x3cb077", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a7c7f

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await expect(erc1967proxyHarness0x9fe4MakeWorldPeaceV2.transfer(ethers.constants.AddressZero, 0)).to.be.revertedWith(
      "ERC20: transfer to the zero address"
    );
  });

  it("0x3cb03c", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b9005
