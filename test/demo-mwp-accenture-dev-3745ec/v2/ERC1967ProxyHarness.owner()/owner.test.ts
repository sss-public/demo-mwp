...
describe("ERC1967ProxyHarness::owner()", async () => {
  ...
  it("0x3caf17", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a5cc6

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.owner()).to.equal(acct0xf39f.address);
