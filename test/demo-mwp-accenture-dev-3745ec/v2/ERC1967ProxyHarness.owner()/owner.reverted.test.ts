...
describe("ERC1967ProxyHarness::owner() - reverted", async () => {
  ...
  it("0x3cb3be", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3bdfcf
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `owner()` */);
  });
