...
describe("ERC1967ProxyHarness::upgradeTo(address)", async () => {
  ...
  it("0x3cb398", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x39c260

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.upgradeTo(makeWorldPeace0x5fbd.address);
  ...
  it("0x3cb15c", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b882d

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.upgradeTo(makeWorldPeaceV20xe7f1.address);
