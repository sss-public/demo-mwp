...
describe("ERC1967ProxyHarness::supportsInterface(bytes4)", async () => {
  ...
  it("0x3cb1f4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3b8f89

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.supportsInterface("0x7965db0b")).to.equal(true);
  ...
  it("0x3cb050", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3a1348

    erc1967proxyHarness0x9fe4MakeWorldPeaceV2 = await ethers.getContractAt("MakeWorldPeaceV2", erc1967proxyHarness0x9fe4.address);
    expect(await erc1967proxyHarness0x9fe4MakeWorldPeaceV2.supportsInterface("0x00000000")).to.equal(false);
