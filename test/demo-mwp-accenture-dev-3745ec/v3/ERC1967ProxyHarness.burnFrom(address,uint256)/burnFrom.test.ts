...
describe("ERC1967ProxyHarness::burnFrom(address,uint256)", async () => {
  ...
  it("0x441026", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3fbb60

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burnFrom("0x0100000000000000000000000000000000000000", 0);
  ...
  it("0x440f8a", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41de18

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burnFrom(acct0xf39f.address, 0);
