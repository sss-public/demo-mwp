...
describe("ERC1967ProxyHarness::burnFrom(address,uint256) - reverted", async () => {
  ...
  it("0x440cbe", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f72c7
  ...
  it("0x440bdf", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3fe5cc

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burnFrom(ethers.constants.AddressZero, 0)).to.be.revertedWith(
