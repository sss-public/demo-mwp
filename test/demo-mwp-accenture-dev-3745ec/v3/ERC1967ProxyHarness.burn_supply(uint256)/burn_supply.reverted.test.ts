...
describe("ERC1967ProxyHarness::burn_supply(uint256) - reverted", async () => {
  ...
  it("0x441062", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41c7d5
  ...
  it("0x440e10", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x419dd1

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn_supply(0x30b9d141774cdc3ffd0000n)).to.be.revertedWith(
