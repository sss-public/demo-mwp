...
describe("ERC1967ProxyHarness::burn_supply(uint256)", async () => {
  ...
  it("0x4410b9", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x404b71

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn_supply(0x10b9d141774cdc3ffc0000n);
  ...
  it("0x44108e", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x413313

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn_supply(0xfffffffffffffffffffffn);
  ...
  it("0x440d98", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f2d45

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn_supply(0);
