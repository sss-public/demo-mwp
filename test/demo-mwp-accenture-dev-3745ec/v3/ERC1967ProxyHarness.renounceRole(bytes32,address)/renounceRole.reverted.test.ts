...
describe("ERC1967ProxyHarness::renounceRole(bytes32,address) - reverted", async () => {
  let makeWorldPeaceV30x9fe4,
    acct0xf39f,
  ...
  it("0x440f87", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f9879
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `renounceRole(bytes32,address)` */);
  });

  it("0x440b46", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x407853

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(
      erc1967proxyHarness0xcf7eMakeWorldPeaceV3.renounceRole(
