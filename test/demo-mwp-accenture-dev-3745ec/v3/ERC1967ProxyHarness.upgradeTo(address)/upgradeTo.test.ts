...
describe("ERC1967ProxyHarness::upgradeTo(address)", async () => {
  ...
  it("0x440e1f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x411d83

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.upgradeTo(makeWorldPeace0x5fbd.address);
  ...
  it("0x440d6f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f1835

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.upgradeTo(makeWorldPeaceV30x9fe4.address);
  ...
  it("0x440b7f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4068f4

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.upgradeTo(makeWorldPeaceV20xe7f1.address);
