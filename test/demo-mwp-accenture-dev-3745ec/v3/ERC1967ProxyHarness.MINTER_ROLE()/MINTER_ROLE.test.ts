...
describe("ERC1967ProxyHarness::MINTER_ROLE()", async () => {
  ...
  it("0x440bf8", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x425825

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.MINTER_ROLE()).to.equal(
