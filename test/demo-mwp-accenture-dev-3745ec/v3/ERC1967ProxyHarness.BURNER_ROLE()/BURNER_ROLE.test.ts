...
describe("ERC1967ProxyHarness::BURNER_ROLE()", async () => {
  let acct0xf39f,
  ...
  it("0x440f6b", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3fd77a

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.BURNER_ROLE()).to.equal(
