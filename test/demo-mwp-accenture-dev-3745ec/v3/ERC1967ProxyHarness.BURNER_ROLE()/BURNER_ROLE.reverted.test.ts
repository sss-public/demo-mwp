...
describe("ERC1967ProxyHarness::BURNER_ROLE() - reverted", async () => {
  let acct0xf39f,
  ...
  it("0x440c5f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40a362
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `BURNER_ROLE()` */);
  });
