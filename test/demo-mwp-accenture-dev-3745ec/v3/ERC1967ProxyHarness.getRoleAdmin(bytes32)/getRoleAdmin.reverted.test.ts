...
describe("ERC1967ProxyHarness::getRoleAdmin(bytes32) - reverted", async () => {
  ...
  it("0x440eec", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4171c3
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `getRoleAdmin(bytes32)` */);
  });
