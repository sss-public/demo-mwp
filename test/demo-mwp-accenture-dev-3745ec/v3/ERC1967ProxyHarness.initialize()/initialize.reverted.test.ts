...
describe("ERC1967ProxyHarness::initialize() - reverted", async () => {
  ...
  it("0x440c73", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40be6b

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.initialize()).to.be.revertedWith(
      "Initializable: contract is already initialized"
    );
  });

  it("0x440bdd", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x423698
