...
describe("ERC1967ProxyHarness::totalSupply()", async () => {
  ...
  it("0x440b6c", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f47d6

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.totalSupply()).to.equal(0x10b9d141774cdc3ffc0000n);
