...
describe("ERC1967ProxyHarness::DEFAULT_ADMIN_ROLE() - reverted", async () => {
  let acct0xf39f,
  ...
  it("0x440f43", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f17f0
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `DEFAULT_ADMIN_ROLE()` */);
  });
