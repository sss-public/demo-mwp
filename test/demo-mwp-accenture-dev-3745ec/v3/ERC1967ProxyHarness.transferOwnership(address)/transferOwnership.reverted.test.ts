...
describe("ERC1967ProxyHarness::transferOwnership(address) - reverted", async () => {
  ...
  it("0x440ec4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x427c47
  ...
  it("0x440c43", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40eeec

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.transferOwnership(ethers.constants.AddressZero)).to.be.revertedWith(
