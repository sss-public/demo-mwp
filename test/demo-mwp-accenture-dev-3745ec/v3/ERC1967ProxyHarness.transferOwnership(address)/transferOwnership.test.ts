...
describe("ERC1967ProxyHarness::transferOwnership(address)", async () => {
  ...
  it("0x4410f9", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4050c4

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.transferOwnership("0x0100000000000000000000000000000000000000");
  ...
  it("0x440b7c", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41c11a

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.transferOwnership(acct0xf39f.address);
