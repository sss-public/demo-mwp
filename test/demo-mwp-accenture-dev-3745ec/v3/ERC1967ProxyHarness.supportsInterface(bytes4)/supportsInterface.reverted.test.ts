...
describe("ERC1967ProxyHarness::supportsInterface(bytes4) - reverted", async () => {
  ...
  it("0x4410fa", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40d148
  ...
  it.skip("0x4410e5", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40ab3d

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.supportsInterface("0x01010101")).to.be.revertedWithoutReason();
  });
