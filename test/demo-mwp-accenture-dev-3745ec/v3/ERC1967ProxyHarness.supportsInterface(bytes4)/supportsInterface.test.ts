...
describe("ERC1967ProxyHarness::supportsInterface(bytes4)", async () => {
  ...
  it("0x441095", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41a9d6

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.supportsInterface("0x7965db0b")).to.equal(true);
  ...
  it("0x440e7f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3fd131

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.supportsInterface("0x00000000")).to.equal(false);
