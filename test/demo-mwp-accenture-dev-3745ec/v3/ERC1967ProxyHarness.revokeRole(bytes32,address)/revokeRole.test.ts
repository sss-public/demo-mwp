...
describe("ERC1967ProxyHarness::revokeRole(bytes32,address)", async () => {
  ...
  it("0x44101a", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x412446
  ...
  it("0x440edf", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x427002
  ...
  it("0x440e74", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4167bb
  ...
  it("0x440b8c", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41fcc0
