...
describe("ERC1967ProxyHarness::allowance(address,address)", async () => {
  ...
  it("0x440c40", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x428e8d

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.allowance(ethers.constants.AddressZero, ethers.constants.AddressZero)).to.equal(
      0
    );
