...
describe("ERC1967ProxyHarness::PAUSER_ROLE() - reverted", async () => {
  ...
  it("0x440dfd", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4005bd
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `PAUSER_ROLE()` */);
  });
