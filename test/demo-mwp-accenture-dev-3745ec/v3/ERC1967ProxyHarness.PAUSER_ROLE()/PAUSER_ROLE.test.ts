...
describe("ERC1967ProxyHarness::PAUSER_ROLE()", async () => {
  ...
  it("0x440c72", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x408543

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.PAUSER_ROLE()).to.equal(
