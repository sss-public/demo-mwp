...
describe("ERC1967ProxyHarness::hasRole(bytes32,address)", async () => {
  ...
  it("0x4410d2", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3fdb78
  ...
  it("0x441003", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4189ef
  ...
  it("0x440de4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41d624
  ...
  it("0x440b3f", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x404a5c
