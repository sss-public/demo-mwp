...
describe("ERC1967ProxyHarness::balanceOf(address)", async () => {
  ...
  it("0x440fbc", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x4236f1

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.balanceOf(ethers.constants.AddressZero)).to.equal(0);
  ...
  it("0x440cf4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x42086a

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    expect(await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.balanceOf(acct0xf39f.address)).to.equal(0x10b9d141774cdc3ffc0000n);
