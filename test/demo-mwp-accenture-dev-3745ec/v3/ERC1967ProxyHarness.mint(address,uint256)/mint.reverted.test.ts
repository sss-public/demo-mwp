...
describe("ERC1967ProxyHarness::mint(address,uint256) - reverted", async () => {
  ...
  it("0x440f52", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40fc16

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.mint(ethers.constants.AddressZero, 0)).to.be.revertedWith(
      "ERC20: mint to the zero address"
    );
  });

  it("0x440d82", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x418be8
  ...
  it("0x440bf7", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x421ea9

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.mint(ethers.constants.AddressZero, 0x821e19e0c9bab2410000n)).to.be.revertedWith(
