...
describe("ERC1967ProxyHarness::burn(uint256) - reverted", async () => {
  ...
  it("0x440ef9", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3effd1
  ...
  it("0x440b6b", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x42a8bd

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await expect(erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn(0x30b9d141774cdc3ffd0000n)).to.be.revertedWith(
