...
describe("ERC1967ProxyHarness::burn(uint256)", async () => {
  ...
  it("0x441011", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3fb8a3

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn(0xfffffffffffffffffffffn);
  ...
  it("0x440e3e", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x42a80e

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn(0x10b9d141774cdc3ffc0000n);
  ...
  it("0x440db4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x41907d

    erc1967proxyHarness0xcf7eMakeWorldPeaceV3 = await ethers.getContractAt("MakeWorldPeaceV3", erc1967proxyHarness0xcf7e.address);
    await erc1967proxyHarness0xcf7eMakeWorldPeaceV3.burn(0);
