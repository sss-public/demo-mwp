...
describe("ERC1967ProxyHarness::grantRole(bytes32,address) - reverted", async () => {
  ...
  it("0x440cf6", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3f9f0f
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `grantRole(bytes32,address)` */);
  });
