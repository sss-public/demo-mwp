...
describe("ERC1967ProxyHarness::symbol() - reverted", async () => {
  ...
  it("0x441115", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x40b41b
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
