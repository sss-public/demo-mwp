...
describe("ERC1967ProxyHarness::decimals() - reverted", async () => {
  ...
  it("0x440c78", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x418cef
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
