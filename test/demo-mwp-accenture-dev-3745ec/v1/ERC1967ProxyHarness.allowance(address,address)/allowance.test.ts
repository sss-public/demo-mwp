...
describe("ERC1967ProxyHarness::allowance(address,address)", async () => {
  ...
  it("0x38695c", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3790b3

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    expect(await erc1967proxyHarness0xe7f1MakeWorldPeace.allowance(ethers.constants.AddressZero, ethers.constants.AddressZero)).to.equal(0);
