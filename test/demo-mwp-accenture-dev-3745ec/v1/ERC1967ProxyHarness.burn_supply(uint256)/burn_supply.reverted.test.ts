...
describe("ERC1967ProxyHarness::burn_supply(uint256) - reverted", async () => {
  ...
  it("0x386899", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x383843
  ...
  it("0x38687a", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37fb91

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await expect(erc1967proxyHarness0xe7f1MakeWorldPeace.burn_supply(0x30b9d141774cdc3ffd0000n)).to.be.revertedWith(
