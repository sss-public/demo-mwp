...
describe("ERC1967ProxyHarness::approve(address,uint256)", async () => {
  ...
  it("0x3868c0", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3816f9

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.approve("0x0100000000000000000000000000000000000000", 0);
