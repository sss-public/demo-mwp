...
describe("ERC1967ProxyHarness::approve(address,uint256) - reverted", async () => {
  ...
  it("0x386bf4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x38518f
  ...
  it("0x386832", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3786b2

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await expect(erc1967proxyHarness0xe7f1MakeWorldPeace.approve(ethers.constants.AddressZero, 0)).to.be.revertedWith(
