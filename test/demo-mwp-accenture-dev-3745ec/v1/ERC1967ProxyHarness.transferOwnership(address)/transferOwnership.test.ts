...
describe("ERC1967ProxyHarness::transferOwnership(address)", async () => {
  ...
  it("0x386aaa", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37c674

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.transferOwnership("0x0100000000000000000000000000000000000000");
  ...
  it("0x38691a", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37766e

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.transferOwnership(acct0xf39f.address);
