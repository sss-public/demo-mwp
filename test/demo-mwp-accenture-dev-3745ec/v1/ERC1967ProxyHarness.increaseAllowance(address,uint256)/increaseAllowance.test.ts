...
describe("ERC1967ProxyHarness::increaseAllowance(address,uint256)", async () => {
  ...
  it("0x386910", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x38385a

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.increaseAllowance("0x0100000000000000000000000000000000000000", 0);
  ...
  it("0x386886", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37b474

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.increaseAllowance(
