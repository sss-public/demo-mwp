...
describe("ERC1967ProxyHarness::balanceOf(address)", async () => {
  ...
  it("0x386c09", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x380517

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    expect(await erc1967proxyHarness0xe7f1MakeWorldPeace.balanceOf(acct0xf39f.address)).to.equal(0x10b9d141774cdc3ffc0000n);
  ...
  it("0x386ad2", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x38022e

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    expect(await erc1967proxyHarness0xe7f1MakeWorldPeace.balanceOf(ethers.constants.AddressZero)).to.equal(0);
