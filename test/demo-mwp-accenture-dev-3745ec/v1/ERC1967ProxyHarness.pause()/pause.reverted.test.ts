...
describe("ERC1967ProxyHarness::pause() - reverted", async () => {
  ...
  it("0x3868b9", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x3823fc
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `pause()` */);
  });
