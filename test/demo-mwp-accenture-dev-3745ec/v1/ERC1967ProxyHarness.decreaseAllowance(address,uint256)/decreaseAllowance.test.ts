...
describe("ERC1967ProxyHarness::decreaseAllowance(address,uint256)", async () => {
  ...
  it("0x386838", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x38253e

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.decreaseAllowance("0x0100000000000000000000000000000000000000", 0);
