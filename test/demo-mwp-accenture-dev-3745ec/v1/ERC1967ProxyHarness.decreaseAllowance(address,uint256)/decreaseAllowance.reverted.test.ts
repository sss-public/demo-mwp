...
describe("ERC1967ProxyHarness::decreaseAllowance(address,uint256) - reverted", async () => {
  ...
  it("0x3869d0", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37a7b4

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await expect(erc1967proxyHarness0xe7f1MakeWorldPeace.decreaseAllowance(ethers.constants.AddressZero, 0)).to.be.revertedWith(
      "ERC20: approve to the zero address"
    );
  });

  it("0x3869a4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37bfdf
