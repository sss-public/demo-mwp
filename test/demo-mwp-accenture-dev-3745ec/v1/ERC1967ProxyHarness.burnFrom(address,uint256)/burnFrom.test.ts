...
describe("ERC1967ProxyHarness::burnFrom(address,uint256)", async () => {
  ...
  it("0x386bd4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37cf4e

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.burnFrom("0x0100000000000000000000000000000000000000", 0);
  ...
  it("0x386a48", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37cfb4

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    await erc1967proxyHarness0xe7f1MakeWorldPeace.burnFrom(acct0xf39f.address, 0);
