...
describe("ERC1967ProxyHarness::renounceOwnership() - reverted", async () => {
  ...
  it("0x386abf", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37940f
    ...
    await expect(
      acct0xf39f.sendTransaction({
        ...
        data: "",
      })
    ).to.be.revertedWithoutReason(/* value transfer to nonpayable call: `renounceOwnership()` */);
  });
