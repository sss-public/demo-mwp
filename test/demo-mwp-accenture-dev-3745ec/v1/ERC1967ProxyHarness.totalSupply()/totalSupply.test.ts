...
describe("ERC1967ProxyHarness::totalSupply()", async () => {
  ...
  it("0x386ba4", async () => {
    // http://172.16.0.71/internal/root/0x374624/path/0x37e150

    erc1967proxyHarness0xe7f1MakeWorldPeace = await ethers.getContractAt("MakeWorldPeace", erc1967proxyHarness0xe7f1.address);
    expect(await erc1967proxyHarness0xe7f1MakeWorldPeace.totalSupply()).to.equal(0x10b9d141774cdc3ffc0000n);
